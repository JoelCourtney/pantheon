...
3. call updateCharacter(). This queries the server for the character object. The readyStateChange callback will call callDisplayCallbacks() when it returns successfully.
4. Wait for events to be triggered by modules. The modules will send requests to the server on their own when the user interacts with the UI. The response will be the updated Character, which will be displayed again as before.
*/
